...
(function (root, factory) {
    ...
    defaults = {
        ...
        locale: {
            buttons: {
                prev: '../img/prev-icon.png',
                next: '../img/next-icon.png',
                close: '&times;',
                reset: 'Reset',
                apply: 'Apply',
            },
    ...
    renderTopButtons = function(opts)
    {
        return '<div class="lightpick__toolbar">'
            + ''
            + '<button type="button" class="lightpick__previous-action"><img src="' + opts.locale.buttons.prev + '"/></button>'
            + '<button type="button" class="lightpick__next-action"><img src="' + opts.locale.buttons.next + '"/></button>'
