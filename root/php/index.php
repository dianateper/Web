...
<html lang="en">
	<head>
		...
		<link media="only screen and (max-width: 600px)" rel="stylesheet" href="../css/smallscreenIndex.css"/>
		<link media="only screen and (min-width: 601px) and (max-width: 1024px)" rel="stylesheet" href="../css/middlescreenIndex.css"/>
	</head>
